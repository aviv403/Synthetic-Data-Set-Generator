...
class DatasetGenerator:
    def __init__(self, top=None):
        ...
        self.InfoBtn = tk.Button(self.MainFrame)
        ...
        self.SaveToBtn = tk.Button(self.MainFrame)
...
def prepare():
        global fileFlag, fileFlag, txtFlag, revFlag
        ...
        for txt in textList:
            run(txt, fontname, fontsizes, angles, degredations, revFlag)
